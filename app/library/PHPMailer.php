 ...
 * @license   http://www.gnu.org/copyleft/lesser.html GNU Lesser General User License
...
class PHPMailer
{
    ...
    /**
     * Set the User and private key files and password for S/MIME signing.
     *
    ...
    /**
     * Allows for User read access to 'to' property.
    ...
    /**
     * Allows for User read access to 'cc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for User read access to 'bcc' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for User read access to 'ReplyTo' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
    ...
    /**
     * Allows for User read access to 'all_recipients' property.
     * Before the send() call, queued addresses (i.e. with IDN) are not yet included.
     *
     * @return array
     */
